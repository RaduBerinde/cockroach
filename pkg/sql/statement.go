...
func newStatement(stmt parser.Statement, queryID ClusterWideID) *Statement {
	return &Statement{
		Statement:     stmt,
		AnonymizedStr: anonymizeStmt(stmt.AST),
		QueryID:       queryID,
	}
}

func newStatementFromPrepared(prepared *PreparedStatement, queryID ClusterWideID) *Statement {
	return &Statement{
