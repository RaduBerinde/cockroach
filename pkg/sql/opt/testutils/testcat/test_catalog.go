...
func (tc *Column) InvertedColumnOrdinal() int {
	if tc.InvertedColOrdinal < 0 {
		panic(errors.AssertionFailedf("InvertedColumnOrdinal called on non-virtual column"))
	}
	return tc.InvertedColOrdinal
}
